#!/usr/bin/env python3
"""Append missing skills to course_database.py."""
...
append_skill("Data Analytics",
    [("IoT Data Analytics","Udemy","https://www.udemy.com/course/iot-data-analytics"),
     ...
     ("Time Series Analysis","Pluralsight","https://www.pluralsight.com/courses/time-series-analysis"),
     ("Edge Analytics","LinkedIn Learning","https://www.linkedin.com/learning/topics/iot-analytics"),
     ("Real-Time Data Processing","DataCamp","https://www.datacamp.com/courses/iot-analytics")],
    [("Splunk","IoT Analytics Intern","Remote","https://www.splunk.com/careers"),
     ("Cloudera","Data Engineering Intern","Hybrid","https://www.cloudera.com/careers"),
     ("Databricks","IoT Data Intern","On-site","https://www.databricks.com/company/careers")])

# Close the dictionary
with open(OUT, "a", encoding="utf-8") as f:
    f.write("}\n")

print("All missing skills appended and dictionary closed successfully")
