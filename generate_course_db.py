#!/usr/bin/env python3
"""Generate comprehensive course_database.py with 700+ items."""

import json

# Define all skills and their real courses/internships
SKILL_DATA = {
    # === PROGRAMMING ===
    "Python": {
        "courses": [
            ...
            ("Python for Data Science", "DataCamp", "https://www.datacamp.com/courses/python-data-science"),
        ],
        "internships": [
    ...
    "Java": {
        "courses": [
            ...
            ("Spring Boot Microservices", "Udemy", "https://www.udemy.com/course/spring-boot-microservices"),
        ],
        "internships": [
    ...
    "C++": {
        "courses": [
            ...
            ("C++ Data Structures", "Udemy", "https://www.udemy.com/course/cpp-data-structures"),
        ],
        "internships": [
    ...
    "TensorFlow": {
        "courses": [
            ...
            ("TensorFlow 2.0 Complete Guide", "Udemy", "https://www.udemy.com/course/tensorflow
